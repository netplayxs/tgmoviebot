...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('updates', url='https://t.me/muhammed_salman'),
            InlineKeyboardButton('movie club', url='https://t.me/muhammed_salman')
            ],[
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            buttons = [
                [
                    InlineKeyboardButton('support', url='https://t.me/muhammed_salman'),
                    InlineKeyboardButton('channel', url='https://t.me/muhammed_salman')
                ],
                [
                    InlineKeyboardButton('Series & Movie Club', url=f'https://t.me/muhammed_salman')
                ]
                ]
            try:
